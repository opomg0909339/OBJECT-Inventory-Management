...
<body>
<form method="POST" action="R15.php">
  <?php
  ...
  <?php
    ...
    <?php
      ...
      $rows = $stmt->fetchAll();
      foreach ($rows as $r)
      echo "<br>訂單編號:".$OD."<br>"."廠商名稱:".$r["MANUFACTNAME"]."廠商代號:".$r["MANUFACTNUM"]."<br>"."廠商地址:".$r["ADDRESS"]."<br>"."訂單日期:".$r["DATE"]."<br>"."連絡電話:".$r["PHONE"]."<br>";
      //------------------------------------------
